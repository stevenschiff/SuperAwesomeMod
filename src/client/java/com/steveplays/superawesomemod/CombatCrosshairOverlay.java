...
public final class CombatCrosshairOverlay {
    ...
    private static void onHudRender(GuiGraphics g, DeltaTracker tickCounter) {
        ...
        boolean inRange = target != null && target.isAttackable();

        int tint = inRange ? CombatCrosshairData.getInRangeARGB() : CombatCrosshairData.getOutOfRangeARGB();

        // Draw the vanilla crosshair sprite again with the chosen tint on top.
        ...
        g.blitSprite(RenderPipelines.GUI_TEXTURED, CROSSHAIR_SPRITE,
            cx, cy, CROSSHAIR_SIZE, CROSSHAIR_SIZE, tint);
    }
}
